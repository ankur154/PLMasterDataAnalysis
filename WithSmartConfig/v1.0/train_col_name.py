...
def classify(sentence,condition=True,show_details=False):
	...
	training_data.append({"class":"SPEC_NUMBER", "sentence":"SPEC ATTACHED"})
	training_data.append({"class":"SPEC_NUMBER", "sentence":"SPECN ATTACHED"})
	training_data.append({"class":"SPEC_NUMBER", "sentence":"SPEC ATT"})
	training_data.append({"class":"SPEC_NUMBER", "sentence":"SPECIFICATION ATTACHED"})
	training_data.append({"class":"SPEC_NUMBER", "sentence":"SPECN . ATTACH"})
